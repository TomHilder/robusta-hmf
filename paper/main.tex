...
We applied RHMF to Gaia/RVS spectra to identify unusual stellar objects on the stellar main-sequence \citep{GaiaDR4,GaiaRVS}. Here, \emph{unusual} is qualitatively defined by the spectrum deviating significantly from typical stars in neighboring color-magnitude bins, and quantified by the inferred robust weights. Examples of sources that we might expect to find could be binary systems, stars with peculiarly high rotation, or those with signatures of accretion or chromospheric activity.\\
