...
\hogg{The Journals don't like one-sentence paragraphs, so put this in somewhere.}
...
\end{align}
\hogg{If you want ``score'' to be a thing, use the DeclareMathOperator command to make it.}
...
\hoggtodo{Any opinion about plotting fits to ``normal'' spectra? Thus far it's not included.} \hogg{Yes, we should plot both; why are you asking me this here? Ask me again in the relevant figure caption.}
