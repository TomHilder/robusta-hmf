...
\begin{abstract}
  ...
  It works by optimizing a likelihood-like objective function that is adaptive to bad data and has a probabilistic interpretation.
    We deliver a fast JAX implementation, Robusta-HMF, and practical guidance for users.
...
Concludey stuff. \hoggtodo{I heard you don't like having a conclusion section. I don't have a strong opinion so we can drop it if you like.}
