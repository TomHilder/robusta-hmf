...
\frenchspacing % Hogg won't post to arXiv without this.
...
\begin{enumerate}
    ...
    \item \textbf{Outlier sparsity}: The outliers in the data are sparse in that the vast majority of the pixels are not outliers.
    \item \textbf{Outlier uniqueness}: The outliers do not share low-rank structure with one another.
\end{enumerate}
...
\tom{I added two new assumptions about the outliers based on writing I've done elsewhere, I think pre-empting these things can mean less text later. Elsewhere will need some reworkign now though.}
